...
a persistence unit "sistemaPolizasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sistemaPolizas\pom.xml":
...
artifact ("sistemaPolizas.war") is already built. You can build
